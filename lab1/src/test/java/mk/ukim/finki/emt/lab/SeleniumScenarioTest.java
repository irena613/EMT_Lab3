...
//import mk.ukim.finki.emt.lab.model.Hotel;
//import mk.ukim.finki.emt.lab.model.Reservation;
//import mk.ukim.finki.emt.lab.model.RoomType;
...
//        List<Reservation> items = this.bookService.listAll();
...
//
//        ExamAssert.assertEquals("without filter", 10, this.bookService.findPage(null, null, null, 0, 20).getNumberOfElements());
//        ExamAssert.assertEquals("filter by guest name only", 1, this.bookService.findPage("2", null, null, 0, 20).getNumberOfElements());
//        ExamAssert.assertEquals("filter by roomType only", 5, this.bookService.findPage(null, RoomType.SINGLE, null, 0, 20).getNumberOfElements());
//        ExamAssert.assertEquals("filter by hotel only", 2, this.bookService.findPage(null, null, 2L, 0, 20).getNumberOfElements());
//        ExamAssert.assertEquals("filter by guest name and room type", 5, this.bookService.findPage("Reservation", RoomType.SINGLE, null, 0, 20).getNumberOfElements());
//        ExamAssert.assertEquals("filter by room type and hotel", 1, this.bookService.findPage(null, RoomType.SINGLE, 2L, 0, 20).getNumberOfElements());
//        ExamAssert.assertEquals("filter by guest name and hotel", 2, this.bookService.findPage("Reservation", null, 2L, 0, 20).getNumberOfElements());
//        ExamAssert.assertEquals("filter by all", 1, this.bookService.findPage("Reservation", RoomType.SINGLE, 2L, 0, 20).getNumberOfElements());
//
//        SubmissionHelper.endTest();
//    }
//
...
//        List<Reservation> reservations = this.bookService.listAll();
//
...
//
//        reservations = this.bookService.listAll();
...
//                .andExpect(MockMvcResultMatchers.redirectedUrl(DEFAULT_URL));
//
//        items = this.bookService.listAll();
